                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            ...
                            <img class="rounded-circle" src="/images/shawon-dp.jpg"
                                width="31"alt="{{ Session::get('name') }}">
                            <div class="user-text">
                                <h6>{{ Session::get('name') }}Md. Bokhtiar Nadeem Shawon</h6>
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                ...
                                <img src="/images/shawon-dp.jpg" alt="{{ Session::get('name') }}"
                        ...
                        <a class="dropdown-item" href=""><i style="margin-right:1rem;"
